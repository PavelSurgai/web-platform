...
import LiveGamesAll from '../LiveGamesAll/LiveGamesAll';
...
const LiveGame = ({ token, operatorId, actionProcessing, lang, getEzugiToken }) => {
  ...
  const url = `https://play.livetables.io/auth/?token=${token}&operatorId=${operatorId}&language=${formatedLang}&selectGame=${game}&homeUrl=https://viagenspt.com/`;
  return (
    <div className={b()}>
