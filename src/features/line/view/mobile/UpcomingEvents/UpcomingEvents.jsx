...
class UpcomingEvents extends React.Component {
  ...
  render() {
    ...
    const { locale, sportID, countryID, tourneys, addToBasket, bets, sports, addFavoritEvent, favoritesList } = this.props;
    const { activeTime } = this.state;
  ...
  changeVisibilityEvents = tourneyID => {
    ...
    if (tourney.events.length === 0) {
      loadUpcomingEventsByTourney(sportID, countryID, tourneyID, lang);
